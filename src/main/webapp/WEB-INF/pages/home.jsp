...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <a class="logo" href="home.html">events</a>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="img/home-1.jpg" alt= width="1200" height="700">
        ...
        <div class="item">
            <img src="img/about.jpg" width="1200" height="700">
            <div class="carousel-caption">
                <h3>Event 1</h3>
        ...
        <div class="item">
            <img src="img/home-2.jpg" width="1200" height="700">
            <div class="carousel-caption">
                <h3>Event 2</h3>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <a href="" data-toggle="collapse">
                <img src="img/home-2.jpg" class="img-circle event" alt="Sports Events" width="255" height="255">
            </a>
        </div>
        <div class="col-sm-4">
            <p class="text-center"><strong>ART</strong></p><br>
            <a href="" data-toggle="collapse">
                <img src="img/home-2.jpg" class="img-circle event" alt="Food & Drinks Evnts" width="255" height="255">
            </a>
        </div>
        <div class="col-sm-4">
            <p class="text-center"><strong>THEATRE</strong></p><br>
            <a href="#demo3" data-toggle="collapse">
                <img src="img/home-2.jpg" class="img-circle event" alt="Art Events" width="255" height="255">
            </a>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="modalLabel"><strong><center>Sign Up</center></strong></h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="modalLabel"><strong><center>Sign In</center></strong></h3>
                <p>Not a member?
